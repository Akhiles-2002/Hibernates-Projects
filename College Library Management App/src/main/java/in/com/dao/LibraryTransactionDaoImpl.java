...
public class LibraryTransactionDaoImpl implements ILibraryTransactionDao {
		...
		try {
			...
			if (connection != null) {
				prepareStatement1 = connection
						.prepareStatement("select sid,bid,issuedate,duedate,submitdate,fine from library_Transaction");
			}
			if (prepareStatement1 != null) {
				resultSet1 = prepareStatement1.executeQuery();
			}
